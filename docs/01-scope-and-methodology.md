...
## 1.2 Scope
In scope: Five key assets defined in the asset inventory (doc 02).
...
- **Immutability of genomic data:** Unlike passwords or financial credentials, a DNA profile
  cannot be changed after exposure. This characteristic elevates impact scores for all risks
  affecting genomic sequences (A-001) and clinical metadata (A-002) to Very High as a
  justified baseline, regardless of likelihood. This aligns with GDPR Article 9 treatment of
  genomic data as a special category requiring heightened protection.
- **Adversary capability caveat:** The baseline assumes moderate adversary capability (Table D-3).
  Genomic data platforms attract high-capability threat actors including APT groups, ransomware
  operators with healthcare specialization, and commercial competitors. Future assessments
  should evaluate high-capability adversary scenarios specifically for A-001 and A-002.
